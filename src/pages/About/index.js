...
const About = ({ forwardRef, midRef }) => {
  ...
  return (
    <div
      ref={forwardRef}
      className="relative flex flex-col items-center justify-center w-full h-screen pl-12 text-4xl text-gray-700 bg-white lg:flex-row overflow-clip"
    >
      <div className="w-1/2 p-4 ">
        <div className="flex justify-start ">
          <h1 className="mb-2 text-xl text-gray-700 sm:text-2xl">About me</h1>
        </div>
        <div className="space-y-1 text-sm text-left sm:text-lg sm:space-y-6">
          <div>
            ...
            develop their cutting edge human resource software. Since beginning
            my journey with Bright in January 2021 I have been part of a small
            team working on a number of exciting projects.
          </div>
          ...
          <div>
            ...
            your own time. This took alot of self disicpline and determination.
            Before that I worked in sales and retail, I have found alot of the
            skills learnt have been useful during my time with Bright, ability
            to communicate well and being a good team player I feel are some of
            the most important skills as a developer.
          </div>
        </div>
      </div>
        ...
        <ul>
          ...
          <ListItem
            text="I concieved and built an alternative rota planner as a prototype for an idea I had,
             after demoing it was allotted time to be be fully develeoped. It now the primary view used by over 70%
